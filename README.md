...
テンプレートは [examples/project-agents.md](examples/project-agents.md) を参照。

## ファイル構成

| ファイル | 説明 |
|---|---|
| `AGENTS.md` | 共通運用ガイド（Superpower スキル運用フロー含む） |
| `examples/project-agents.md` | プロジェクト固有 AGENTS.md のテンプレート |
